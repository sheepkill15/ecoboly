...
const Picker = ({items, onValueChanged, style}: {items: Array<string>; onValueChanged: (value: string) => void; style: ViewStyle}) => {
    ...
    return <View style={{flex: 1}}><DropdownPicker theme={currTheme.toUpperCase()} searchable={false} open={open} value={value} items={ownItems} setValue={setValue} setItems={setItems} setOpen={setOpen} /></View>
}
